...
const Header: React.FC<HeaderProps> = ({ onAddClientClick, onAddLoanClick, onQuickPaymentClick, onMenuClick, theme, onThemeToggle, currentView, setCurrentView, onLogout }) => {
        ...
        <header className="flex-shrink-0 bg-white dark:bg-slate-800 shadow-sm z-10 border-b border-gray-200 dark:border-slate-700">
            <div className="flex items-center justify-between p-3 sm:p-4">
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <button onClick={onLogout} className="p-2 rounded-full text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-primary dark:focus:ring-offset-slate-800" aria-label="Logout" title="Sair">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
